          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                >
                  <h2>
                    WE’RE AN <span>INDEPENDENT</span> DIGITAL AGENCY
                    WITH A TEAM OF DESIGNERS & CREATIVE DEVELOPERS WHO
                    <span> LOVE </span>IN CRAFTING DIGITAL EXPERIENCES
                  </h2>
                  <div class="dash"></div>
                </div>
              </div>
        ...
        <div class="container">
          ...
          >
            ...
            <div class="col-lg-8 mt-30">
              <p>
                We are a small, but powerful and independent team of
                digital project creators, truly loving our job. We
                start each day with new ideas, help each other grow
                and learn from one another. Each project needs to be
                perfected to the extent that allows us to support the
                reputation of a trusted partner and raises the bar of
      ...
      <div class="bg-main">
        <div class="container">
          <div class="row">
            <!-- Clients -->
            <div
              class="col-md-12 col-lg-8 offset-lg-2 text-center m-each"
            >
              <h2
                data-aos-once="true"
                data-aos="fade-up"
            ...
            <div class="row">
              ...
              <div class="col-md-4 mt-30">
                <div class="address">
                  ...
                  <h4>Address</h4>
                  <p>
                    75 New York - Bourbon Street 10/555 Klaten -
                    Central Java
                  </p>
                </div>
              </div>
